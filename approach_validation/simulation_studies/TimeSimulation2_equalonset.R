...
# This specific simulation tests a scenario where the people with and without variant f have equal onset variability.
# Therefore disease state rates are expected to be more stable across ages of sampling permitting reasonable lifetime penetrance estimates at younger ages.
...
outfile = file.path(".","TimeSimulation2_equalonset.pdf") #Set outpath
