...
# onsetRateDiff >1 and therefore the disease onset window is more compressed for people with variant f which may affect penetrance estimation
# [this simulation is approx. the inverse of time simulation 4]
...
simResult <- simADPenetrance(onsetRateDiff = 1.3,
...
outfile = file.path(".","TimeSimulation3_1pt3onset.pdf") #Set outpath
